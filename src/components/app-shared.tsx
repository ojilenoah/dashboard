...
export const navGroups: SidebarNavGroup[] = [
	...
	},
	{
		label: "Workspace",
		items: [
			{ title: "Team", path: "/team", icon: <UsersIcon /> },
			{ title: "Integrations", path: "/integrations", icon: <PlugIcon /> },
			{ title: "API Keys", path: "/api-keys", icon: <KeyRoundIcon /> },
		],
	},
	{
		...
		items: [
			...
			{ title: "Billing", path: "/billing", icon: <CreditCardIcon /> },
		],
	},
];
